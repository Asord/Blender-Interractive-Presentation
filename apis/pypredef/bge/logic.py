...
KX_ACTION_BLEND_ADD = int
KX_ACTION_BLEND_BLEND = int
KX_ACTION_MODE_LOOP = int
KX_ACTION_MODE_PING_PONG = int
KX_ACTION_MODE_PLAY = int
KX_ACT_ARMATURE_DISABLE = int
KX_ACT_ARMATURE_ENABLE = int
KX_ACT_ARMATURE_RUN = int
KX_ACT_ARMATURE_SETINFLUENCE = int
KX_ACT_ARMATURE_SETTARGET = int
KX_ACT_ARMATURE_SETWEIGHT = int
KX_ACT_MOUSE_OBJECT_AXIS_X = int
KX_ACT_MOUSE_OBJECT_AXIS_Y = int
KX_ACT_MOUSE_OBJECT_AXIS_Z = int
...
KX_MOVEMENT_ALL_AXIS = int
KX_MOVEMENT_AXIS_NEG_X = int
KX_MOVEMENT_AXIS_NEG_Y = int
KX_MOVEMENT_AXIS_NEG_Z = int
KX_MOVEMENT_AXIS_POS_X = int
KX_MOVEMENT_AXIS_POS_Y = int
KX_MOVEMENT_AXIS_POS_Z = int
KX_PARENT_REMOVE = int
KX_PARENT_SET = int
KX_PROPSENSOR_CHANGED = int
KX_PROPSENSOR_EQUAL = int
KX_PROPSENSOR_EXPRESSION = int
KX_PROPSENSOR_GREATERTHAN = int
KX_PROPSENSOR_INTERVAL = int
KX_PROPSENSOR_LESSTHAN = int
...
KX_STATE_OP_NEG = int
KX_STATE_OP_SET = int
KX_STEERING_FLEE = int
KX_STEERING_PATHFOLLOWING = int
KX_STEERING_SEEK = int
KX_TRACK_TRAXIS_NEG_X = int
KX_TRACK_TRAXIS_NEG_Y = int
KX_TRACK_TRAXIS_NEG_Z = int
KX_TRACK_TRAXIS_POS_X = int
KX_TRACK_TRAXIS_POS_Y = int
KX_TRACK_TRAXIS_POS_Z = int
KX_TRACK_UPAXIS_POS_X = int
KX_TRACK_UPAXIS_POS_Y = int
KX_TRACK_UPAXIS_POS_Z = int
KX_TRUE = int
def LibFree(*argv):
	pass
...
def getClockTime(*argv):
	"""Get the last BGE render time. The BGE render time is the simulated time corresponding to the next scene that will be renderered"""
...
def getFrameTime(*argv):
	"""Get the BGE last frametime. The BGE frame time is the simulated time corresponding to the last call of the logic system"""

def getInactiveSceneNames(*argv):
...
def getRealTime(*argv):
	"""Get the real system time. The real-time corresponds to the system time"""
...
def getTimeScale(*argv):
	"""Get the time multiplier"""

def getUseExternalClock(*argv):
	"""Get if we use the time provided by an external clock"""

globalDict = dict
joysticks = list
keyboard = SCA_PythonKeyboard = None
def loadGlobalDict(*argv):
	"""LoadGlobalDict()
Loads bge.logic.globalDict from a file"""

mouse = SCA_PythonMouse = None
...
sends a message in same manner as a message actuator subject = Subject of the message body = Message body to = Name of object to send the message to from = Name of object to send the string from"""

def setClockTime(*argv):
	"""Set the BGE render time. The BGE render time is the simulated time corresponding to the next scene that will be rendered"""
...
def setUseExternalClock(*argv):
	"""Set if we use the time provided by an external clock"""
