...
class BMEdgeSeq:
   ...
   def sort(key=None, reverse=False):
      """Sort the elements of this sequence, using an optional custom sort key.
         Indices of elements are not changed, BMElemeSeq.index_update(self) can be used for that.
...
class BMLayerCollection:
   ...
   def items(self):
      """Return the identifiers of collection members
         (matching pythons dict.items(self) functionality).
   ...
   def keys(self):
      """Return the identifiers of collection members
         (matching pythons dict.keys(self) functionality).
   ...
   def values(self):
      """Return the values of collection
         (matching pythons dict.values(self) functionality).
...
class BMLoop:
   ...
   link_loop_next = object()
   """The next face corner (read-only).
      
   """
   

   link_loop_prev = object()
   """The previous face corner (read-only).
      
   """
   

   link_loop_radial_next = object()
   """The next loop around the edge (read-only).
      
   """
   

   link_loop_radial_prev = object()
